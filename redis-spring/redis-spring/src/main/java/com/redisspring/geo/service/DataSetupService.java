package com.redisspring.geo.service;

import com.redisspring.geo.dto.GeoLocation;
import com.redisspring.geo.dto.Restaurant;
import com.redisspring.geo.util.RestaurantUtil;
...
public class DataSetupService implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Flux.fromIterable(RestaurantUtil.getRestaurants())
				...
				.doFinally(s -> System.out.println("restaurants added " + s)).subscribe();
	}
